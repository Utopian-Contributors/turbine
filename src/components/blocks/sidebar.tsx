  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'group peer hidden lg:flex flex-col shrink-0 h-screen sticky top-0 overflow-hidden text-sidebar-foreground',
          'duration-300 transition-[width] ease-in-out',
          'w-[--sidebar-width] data-[state=collapsed]:w-[--sidebar-width-icon]',
          variant === 'floating' || variant === 'inset'
            ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]'
            : '',
          variant !== 'floating' && variant !== 'inset' && side === 'left'
            ? 'border-r border-sidebar-border'
            : '',
          variant !== 'floating' && variant !== 'inset' && side === 'right'
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow group-data-[collapsible=icon]:w-fit"
        >
          {children}
        </div>
      </div>
